...
class TelephoneFst(GraphFst):
    ...
    Finite state transducer for verbalizing telephone numbers, e.g.
        telephone { country_code: "cộng tám mươi tư" number_part: "chín một hai ba bốn năm sáu bảy tám" extension: "một hai ba"  }
        -> cộng tám mươi tư, chín một hai ba bốn năm sáu bảy tám, một hai ba
